"""
Django settings for chatto_9 project.
...
WSGI_APPLICATION = 'chatto_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chatto_9 API",
    "DESCRIPTION": "API documentation for chatto_9 App",
    "VERSION": "v1",
}
